...
dir.create("/Users/danfab/Remolina/TE_maps/res_files/corrected/edit/sign_TE_plots/effcut03/")
dir.create("/Users/danfab/Remolina/TE_maps/res_files/corrected/edit/output_stat/")

#Settings
output_path = "/Users/danfab/Remolina/TE_maps/res_files/corrected/edit/sign_TE_plots/effcut03/" 
...
table(sort(tapply(tab$cov,tab$TEfam,max)) == 0) #29 without any reads mapping
...
nrow(stat_output.filter.sign) #51 are significant after Bonferroni
...
pdf(file = paste(output_path1,"insertion_diff_Remolina_Filter_vs_NoFilter_EffCut03.pdf", sep =""),width = 7,height = 9)
...
stat_output.filter.Edit = melt(data = stat_output.filter.sign[,c(23,3:8)],value="flybase_name")
...
ggsave(filename = "all_sign_appr1_remolina_Effcut03.pdf",plot = boxplot.mean,width = 16,height = 16) #on dryad
...
nrow(remo.stat.filt.sign) #51
nrow(remo.stat.filt.signUP) #41
nrow(remo.stat.filt.signDOWN) #10
