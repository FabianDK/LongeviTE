...
dir.create("/Users/danfab/Fabian/TE_maps/res_files/corrected/edit/sign_TE_plots/effcut03/")
dir.create("/Users/danfab/Fabian/TE_maps/res_files/corrected/edit/output_stat/")

#Settings
output_path = "/Users/danfab/Fabian/TE_maps/res_files/corrected/edit/sign_TE_plots/effcut03/"
...
nrow(stat_output.filter.sign) #68
...
pdf(file = paste(output_path1,"insertion_diff_Fabian_Filter_vs_NoFilter_EffCut03.pdf", sep =""),width = 7,height = 9)
...
ggsave(filename = "all_sign_appr1_fabian_effcut03.pdf",plot = boxplot.mean,width = 16,height = 16) #on dryad
...
nrow(fabian.stat.filt.sign) #68
nrow(fabian.stat.filt.signUP) #37
nrow(fabian.stat.filt.signDOWN) #31
