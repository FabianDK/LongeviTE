...
nrow(stat_output.filter.sign) #40
...
nrow(stat_output.noFilt.sign) #40
...
nrow(hoedjes.stat.filt.sign) #40
...
nrow(hoedjes.stat.filt.sign) #40
nrow(hoedjes.stat.filt.signUP) #38
nrow(hoedjes.stat.filt.signDOWN) #2
