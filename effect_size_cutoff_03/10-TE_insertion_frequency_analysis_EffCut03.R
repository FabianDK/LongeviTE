...
eff_cut = 0.3
remo.stat.sign = remo.stat.filt[remo.stat.filt$Bonf == "TRUE" & abs(remo.stat.filt$Diff_SelCont) > eff_cut,]
carnes.stat.sign = carnes.stat.filt[carnes.stat.filt$Bonf == "TRUE" & abs(carnes.stat.filt$Diff_SelCont) > eff_cut,]
fabian.stat.sign = fabian.stat.filt[fabian.stat.filt$Bonf == "TRUE" & abs(fabian.stat.filt$Diff_SelCont) > eff_cut,]
hoed.stat.sign = hoed.stat.filt[hoed.stat.filt$Bonf_Full == "TRUE" & abs(hoed.stat.filt$Diff_PostEarly) > eff_cut,]
...
#####################################################
carnes.te2.stat.pop.combi.ns = carnes.te2.stat.pop.combi[carnes.te2.stat.pop.combi$Bonf == "FALSE" | abs(carnes.te2.stat.pop.combi$Diff_SelCont) <= effcut,]
carnes.te2.stat.pop.combi.ns$Type = "ns"
fabian.te2.stat.pop.combi.ns = fabian.te2.stat.pop.combi[fabian.te2.stat.pop.combi$Bonf == "FALSE" | abs(fabian.te2.stat.pop.combi$Diff_SelCont) <= effcut,]
fabian.te2.stat.pop.combi.ns$Type = "ns"
remo.te2.stat.pop.combi.ns = remo.te2.stat.pop.combi[remo.te2.stat.pop.combi$Bonf == "FALSE" | abs(remo.te2.stat.pop.combi$Diff_SelCont) <= effcut,]
remo.te2.stat.pop.combi.ns$Type = "ns"
hoed.te2.stat.pop.combi.ns = hoed.te2.stat.pop.combi[hoed.te2.stat.pop.combi$Bonf_Full == "FALSE" | abs(hoed.te2.stat.pop.combi$Diff_PostEarly) <= effcut,]
hoed.te2.stat.pop.combi.ns$Type = "ns"
 
carnes.te2.stat.pop.combi.sign = carnes.te2.stat.pop.combi[carnes.te2.stat.pop.combi$Bonf == "TRUE" & abs(carnes.te2.stat.pop.combi$Diff_SelCont) > eff_cut,]
fabian.te2.stat.pop.combi.sign = fabian.te2.stat.pop.combi[fabian.te2.stat.pop.combi$Bonf == "TRUE" & abs(fabian.te2.stat.pop.combi$Diff_SelCont) > eff_cut,]
remo.te2.stat.pop.combi.sign = remo.te2.stat.pop.combi[remo.te2.stat.pop.combi$Bonf == "TRUE" & abs(remo.te2.stat.pop.combi$Diff_SelCont) > eff_cut,]
hoed.te2.stat.pop.combi.sign = hoed.te2.stat.pop.combi[hoed.te2.stat.pop.combi$Bonf_Full == "TRUE" & abs(hoed.te2.stat.pop.combi$Diff_PostEarly) > eff_cut,]
...
pdf(paste(output_path,"FigS7_correlation_with_Kofler2015_effcut03.pdf",sep=""), width=12, height=20)
...
pdf(paste(output_path,"FigS8_correlation_RobertFreq_vs_CopyNumb_EffCut03.pdf",sep=""), width=12, height=20)
par(mfrow=c(4,2),font.axis=1,font.lab=2,lwd=1.2,cex=1,mar=c(4.5,4.5,2,3))
...
pdf(paste(output_path,"FigS9_correlation_OurFreq_vs_CopyNumb_Effcut03.pdf",sep=""), width=12, height=20)
par(mfrow=c(4,2),font.axis=1,font.lab=2,lwd=1.2,cex=1,mar=c(4.5,4.5,2,3))
...
t.test(carnes.te2.stat.pop.combi.sign.rob[carnes.te2.stat.pop.combi.sign.rob$Type.x == "S>C",]$av_freq,
       carnes.te2.stat.pop.combi.sign.rob[carnes.te2.stat.pop.combi.sign.rob$Type.x == "C>S",]$av_freq)$p.value #0.002155317
...
t.test(top10.c$av_freq ~ top10.c$Type.x)$p.value #0.02675
text(1.5,1.14,"*",cex=1.8)
brackets(x1 = 1, y1 = 1.05,
         x2 = 2, y2 = 1.05, 
         h = 0.05, ticks=NA, curvature = 0.5, type = 4,
...
t.test(fabian.te2.stat.pop.combi.sign.rob[fabian.te2.stat.pop.combi.sign.rob$Type.x == "S>C",]$av_freq,
       fabian.te2.stat.pop.combi.sign.rob[fabian.te2.stat.pop.combi.sign.rob$Type.x == "C>S",]$av_freq)$p.value #0.005981939
...
t.test(remo.te2.stat.pop.combi.sign.rob[remo.te2.stat.pop.combi.sign.rob$Type.x == "S>C",]$av_freq,
       remo.te2.stat.pop.combi.sign.rob[remo.te2.stat.pop.combi.sign.rob$Type.x == "C>S",]$av_freq)$p.value #0.02965886
...
t.test(hoed.te2.stat.pop.combi.sign.rob[hoed.te2.stat.pop.combi.sign.rob$Type.x == "S>C",]$av_freq,
       hoed.te2.stat.pop.combi.sign.rob[hoed.te2.stat.pop.combi.sign.rob$Type.x == "C>S",]$av_freq)$p.value #0.001309825
