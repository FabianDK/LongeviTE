...
nrow(stat_output.filter.sign) #57
...
#pdf(file = paste(output_path1,"insertion_diff_Carnes_Filter_vs_NoFilter.pdf", sep =""),width = 7,height = 9)
...
nrow(carnes.stat.filt.sign) #57
nrow(carnes.stat.filt.signUP) #38
nrow(carnes.stat.filt.signDOWN) #19
