...
int.fab.sign = int.fab[int.fab$Bonf == "TRUE",]
int.remo.sign = int.remo[int.remo$Bonf == "TRUE",]
int.carn.sign = int.carn[int.carn$Bonf == "TRUE",]
int.hoed.sign = int.hoed[int.hoed$Bonf_Full == "TRUE",]
...
#Fabian2018
#Pvalues
sum(log2(fab$ratio.SC.to.CS) >= fab.ratio) / length(fab$ratio.SC.to.CS) #0.4
sum(log2(fab.50$ratio.SC.to.CS) >= fab.ratio) / length(fab.50$ratio.SC.to.CS) #0.24
sum(log2(fab.75$ratio.SC.to.CS) >= fab.ratio) / length(fab.75$ratio.SC.to.CS) #0.1
...
box(lty = 1, col = 'black')
legend(x=1.2, y=830, "P = 0.4", bty="n",cex = 1.4,text.col = "red")
...
abline(v=fab.ratio,lty=2,lwd=2,col="red")
box(lty = 1, col = 'black')
legend(x=1.2, y=830, "P = 0.24", bty="n",cex = 1.4,text.col = "red")
...
abline(v=fab.ratio,lty=2,lwd=2,col="red")
box(lty = 1, col = 'black')
legend(x=1.2, y=830, "P = 0.1", bty="n",cex = 1.4,text.col = "red")
