#ESTIMATION OF TE ABUNDANCE WITH DEVIATE
...
#6) Raw coverage of single copy genes
for file in Carnes/TE_maps/res_files/raw/*.Dmel_*raw
  do
grep -v '^#' $file | awk 'BEGIN{OFS="\t"}{print $1,$2,$3,$9,$10,$11}' | sed 's/_merge.header_edit.fastq//g' >>  Carnes/TE_maps/res_files/raw/edit/carnes_all_Dmel_rawCov_edited.txt
done
...
#6) Raw coverage of single copy genes
for file in Fabian/TE_maps/res_files/raw/*.Dmel_*raw
  do
grep -v '^#' $file | awk 'BEGIN{OFS="\t"}{print $1,$2,$3,$9,$10,$11}' | sed 's/_merge.header_edit.fastq//g' >>  Fabian/TE_maps/res_files/raw/edit/fabian_all_Dmel_rawCov_edited.txt
done
...
#6) Raw coverage of single copy genes
for file in Remolina/TE_maps/res_files/raw/*.Dmel_*raw
  do
grep -v '^#' $file | awk 'BEGIN{OFS="\t"}{print $1,$2,$3,$9,$10,$11}' | sed 's/_merge.header_edit.fastq//g' >>  Remolina/TE_maps/res_files/raw/edit/remolina_all_Dmel_rawCov_edited.txt
done
...
#6) Raw coverage of single copy genes
for file in Hoedjes/TE_maps/res_files/raw/*.Dmel_*raw
  do
grep -v '^#' $file | awk 'BEGIN{OFS="\t"}{print $1,$2,$3,$9,$10,$11}' | sed 's/_merge.header_edit.fastq//g' >>  Hoedjes/TE_maps/res_files/raw/edit/hoedjes_all_Dmel_rawCov_edited.txt
done
